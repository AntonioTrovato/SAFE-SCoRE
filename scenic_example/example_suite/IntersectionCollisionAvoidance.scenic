"""
SCENARIO: IntersectionCollisionAvoidance.scenic
SOURCE FILE: IntersectionCollisionAvoidance.xosc (SCTrans)
SOURCE HEADER: CARLA:SynchronizeIntersectionEntry
ENTITIES: ego + 0 moving NPC(s), 1 parked, 0 pedestrian(s)
...
so Autoware starts the ego at the recorded pose rather than its own default:
    [140.0000, 55.0000, 0.0, 0.0, 0.0, 180.0000]
"""
...
egoSpawnPt = new OrientedPoint at (140.0000, 55.0000), facing 90.00 deg
adversarySpawnPt = new OrientedPoint at (92.5000, 91.0000), facing -179.38 deg
...
adversary = new Car at adversarySpawnPt, facing adversarySpawnPt.heading,  # source category: bicycle
