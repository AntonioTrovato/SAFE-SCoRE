"""
SCENARIO: VehicleLateralDistance.scenic
SOURCE FILE: VehicleLateralDistance.xosc (SCTrans)
SOURCE HEADER: CARLA:VechicleLateralDistance
...
# adversary: skipped (no spawn position in source)
