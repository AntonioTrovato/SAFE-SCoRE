"""
SCENARIO: LaneOffsetActionExample.scenic
SOURCE FILE: LaneOffsetActionExample.xosc (SCTrans)
SOURCE HEADER: CARLA:ControllerExample
ENTITIES: ego + 1 moving NPC(s), 0 parked, 0 pedestrian(s)
...
adversarySpawnPt = new OrientedPoint at (190.0000, 133.0000), facing -90.00 deg
...
behavior AdversaryBehavior():
    ...
    do FollowLaneBehavior(target_speed=ADVERSARY_SPEED)
...
adversary = new Car at adversarySpawnPt, facing adversarySpawnPt.heading,
      ...
      with initialSpeed 1.0000,  # recorded initial speed (m/s)
